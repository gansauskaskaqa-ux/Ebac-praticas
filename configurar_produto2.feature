...
Funcionalidade: Configurar produto antes de adicionar ao carrinho
  ...
  Cenário: Exigir seleção obrigatória de cor, tamanho e quantidade
    Quando tento adicionar o produto ao carrinho sem selecionar todas as opções o sistema deve impedir a adição ao carrinho
    Então deve exibir uma mensagem informando que cor, tamanho e quantidade são obrigatórios
